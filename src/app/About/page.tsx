    ...
    return (
        ...
        <div className="md:w-1/2 p-2 flex-col-reverse md:flex-col mt-2 flex justify-center items-center mb-2 md:mb-0">
            ...
            <section className='flex flex-col justify-center'>
                <p className='md:mt-5  text-bold text-center text-xl md:text-xl  text-fuchsia-950 font-semibold '>
                    My Life Philosophy:
                </p>
                <p className='mx-20 mt-3 text-xs md:text-lg text-center mb-4 md:mb-0'>
        ...
        <section className='mx-10 mt-3 md:mt-0 md:mx-0'>
            <p className="md:text-lg text-xs font-indie text-center">
            ...
            {/* Navigation Buttons */}
            <section className="flex flex-row justify-center gap-6 text-xs mb-5 md:text-sm">
