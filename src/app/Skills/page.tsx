...
//         <>
//             <div 
//                 className="flex flex-col bg-cover w-full h-screen relative overflow-hidden" 
//                 style={{ backgroundImage: "url('/images/BG (4).jpg')" }}
//             >
//                 <RouteNavBar isOpen={isOpen} toggleMenu={toggleMenu}/>
...
//                     {/* Left side - Tech Skills */}
//                     <div className="w-full md:w-1/2 p-2 flex flex-col items-center mt-[-0.5rem]">
//                         <h2 className="font-indie text-fuchsia-950 text-3xl  md:ml-[-18px]">Tech Skills</h2>
...
//                     {/* Right side - Soft Skills */}
//                     <div className="w-full md:w-[60%] flex flex-col justify-center px-5 mt-4 md:mt-0">
//                         <h3 className="font-indie text-fuchsia-950 text-3xl text-center mt-6">Soft Skills</h3>

//                         <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4 p-5 overflow-x-auto h-[65.5vh]">
//                             {softSkills.map((skill) => (
//                                 <div
//                                     key={skill.id}
//                                     className="bg-fuchsia-950/45 w-full p-3 rounded-xl shadow-lg"
